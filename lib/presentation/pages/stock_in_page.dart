...
class StockInPage extends StatefulWidget {
  ...
  const StockInPage({super.key, required this.currentUser});
...
class _StockInPageState extends State<StockInPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Stock In — Receive goods'),  // FIXED: changed message → title
                ...
                child: Column(
                  children: [
                    _InfoBanner(  // FIXED: changed title → message
                      ...
                      message: 'Use this form to record received goods and increase stock quantities.',
                    ),
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: _items.map((item) {
                              return DropdownMenuItem(
                                value: item.id,
                                child: Text('${item.name} (Current: ${item.quantity})'),
                              );
                            }).toList(),
